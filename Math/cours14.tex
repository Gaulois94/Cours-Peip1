...
où $\left\{\begin{array}{c}
	...
	Alors : 
	\[\begin{array}{rcl}
			\frac{P(x)}{Q(x)} &=& T(x) + \frac{C_{1,1}}{A_1(x)} + \frac{C_{1,2}}{A_1(x)^2} + ... + \frac{C_{1,\alpha_i}}{A_1(x)^{\alpha_i}} \\
																		&& +\frac{C_{2,1}}{A_2(x)} + \frac{C_{2,2}}{A_2(x)^2} + ... + \frac{C_{2,\alpha_i}}{A_2(x)^{\alpha_i}}  \\
